...
<body>
    <nav class="navbar navbar-expand-md">
        ...
        <section class="main">
            ...
            <div class ="container">
                <br><h5><?php echo $session_user;?>Enrolled Unit Student Details</h5>
                    ...
                    <br><h5><?php echo $session_user;?>Enrolled Tutorial Student Details</h5>
                    <table class="table table-bordered table-striped" id="tableedit">
                        <thead>
                            <tr>
                                <th>Student ID</th>
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM tutorialenroll";
                            $result =$mysqli->query($query);
                            while ($row =$result->fetch_array(MYSQLI_ASSOC)):
                                echo "<tr>";
                                echo "<td>{$row['idnumber']}</td>";
