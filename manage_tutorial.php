...
<body>
    <nav class="navbar navbar-expand-md">
            ...
            <div class="collapse navbar-collapse" id="main-navigation">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="signin_success.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="UnitEnrolment.php">UnitEnrolment</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="UnitDetail.php">UnitDetail</a>
                    </li>
                    <li class="nav-item">
...
<section class="main">
    <div class ="container">
        ...
        <a href="TutorialAllocation.php">Back to Tutorial Enroll</a>
        ...
        <table class="table table-bordered table-striped" id="tableedit">
            ...
            <tbody>
                <?php
                //retrive the select data from database to the table 
                  $query = "SELECT * FROM tutorialenroll where idnumber='$session_id'";
                  $result =$mysqli->query($query);
