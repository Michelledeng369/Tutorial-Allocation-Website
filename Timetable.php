...
<body>
    <nav class="navbar navbar-expand-md">
        ...
        <section class="main">
            ...
            <div class ="container">
                <br><h5>Hi, <?php echo $session_user;?>! Your Lecture Timetable</h5>
                    ...
                    <table class="table table-bordered table-striped" id="tableedit">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM unitenroll where idnumber='$session_id'";
                            $result =$mysqli->query($query);
                    ...
                    <br><h5>Hi, <?php echo $session_user;?>! Your Tutorial Timetable</h5>
                    <table class="table table-bordered table-striped" id="tableedit">
                        <thead>
                            <tr>
                                <th>Unit Code</th>
